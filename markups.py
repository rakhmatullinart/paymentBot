...
def edit():
    ...
    add_kat = telebot.types.InlineKeyboardButton(text="Добавить город", callback_data='add_kat')
    delete_kat = telebot.types.InlineKeyboardButton(text="Удалить город", callback_data='delete_kat')
